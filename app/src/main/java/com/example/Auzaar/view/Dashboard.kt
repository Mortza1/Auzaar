...
import com.example.Auzaar.ui.theme.orange
...
fun Dashboard(navController: NavController
    ...
    Scaffold(
        ...
        { section ->
            when (section) {
                DashboardSection.Home -> HomeScreen(HomeScreenViewModel(), navController = navController)
            }
            when (section) {
                DashboardSection.ShoppingCart -> AddToCartScreen(navDrawerViewModel = HomeScreenViewModel())
            }
            when (section) {
